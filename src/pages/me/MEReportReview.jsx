...
function MEReportReview() {
  ...
  const handleSubmit = () => {
    alert("Report submitted to the Director for Review and Approval!");
    navigate("/dashboard");
  };

  return (
    <PageLayout platformLabel="M&amp;E Platform">
      <h2 className="pme-section-title">Reporting on Action Plan &mdash; Review</h2>
      ...
      <p style={{ textAlign: "center", color: "#555", margin: "1rem 0" }}>
        Please review all submitted data. You can go back to make changes.
      </p>
      ...
      <div style={{ textAlign: "center" }}>
        <Link to={`/me/reporting?${qs}`} className="pme-back-link">← Back</Link>
      </div>
    </PageLayout>
  );
}

export default MEReportReview;

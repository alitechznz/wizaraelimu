...
function ActionPlanActivities() {
  ...
  return (
    <PageLayout platformLabel="Planning Platform">
      <h2 className="pme-section-title">Action Plan</h2>
      <p style={{ textAlign: "center", color: "#555", marginBottom: "1rem" }}>
        Select a Shughuli to start populating the Action Plan.
      </p>
      <div className="pme-grid">
        {SHUGHULI.map((s, i) => (
          <div
            ...
            onClick={() => navigate(`/planning/action-plan/${i + 1}?${qs}`)}
          >
            {s}
          </div>
        ))}
...
export default ActionPlanActivities;
